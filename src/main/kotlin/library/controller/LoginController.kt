...
class LoginController(val inputView: LoginAndSignupInputView, val outputView: LoginAndSignupOutputView, val loginService: LoginService, val clock: CustomClock) : Controller{
